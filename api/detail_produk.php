...
<head>
    ...
    <title>RIAA | <?php echo ucwords(($produk != null) ? $produk['prod_nama'] : "Produk Tidak Ditemukan"); ?></title>
...
<body>
    <div class="flex min-h-screen flex-col">
        ...
        <main class="flex-grow pt-10 mx-10 gap-2">
            <section class="flex flex-col md:flex-row items-center md:items-start justify-center flex-wrap">
                <?php if ($produk == null) { ?>
                ...
                <?php } else { ?>
                    ...
                    <div class="w-full bg-slate-200 rounded-md p-5 flex flex-col md:flex-row gap-6">
                        <!-- Gambar produk -->
                        <div class="flex-shrink-0 w-full md:w-auto flex justify-center">
                            <img class="w-full max-w-[250px] aspect-square object-cover object-center rounded-lg shadow-md"
                        ...
                        <div class="flex-1 overflow-hidden">
                            ...
                            <div class="space-y-2 text-sm md:text-base">
                                ...
                                <div class="flex flex-col md:flex-row md:gap-x-4">
                                    ...
                                    <span class="flex-1"><?= ucwords($produk['prod_nama']) ?></span>
                                </div>
                                ...
                                <!-- Harga -->
                                <div class="flex flex-col md:flex-row md:gap-x-4 items-start md:items-center">
                                ...
                                <div class="flex flex-col md:flex-row md:gap-x-4">
                                    ...
                                    <span class="flex-1 break-words"><?= $produk['prod_deskripsi'] ?></span>
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                <?php if (!isset($_SESSION['UserLogin'])) { ?>
                                    <button onclick="login.showModal()"
                                        class="btn px-6 bg-slate-700 hover:bg-slate-600 text-white w-full md:w-auto">
                                        <i class="fa-sharp fa-solid fa-cart-plus text-xl"></i>
                                    </button>
                                <?php } else { ?>
                                    <form action="keranjang.php" method="post" class="w-full md:w-auto">
